////======================================================================
////
////        Filename    : SqlServerDatabase.cs
////        Description : Database for SqlServer
////
...
namespace Database.Core
{
    public class SqlServerDatabase : IDatabase
    {
        ...
        public SqlServerDatabase(string connectionString)
        {
            ...
            {
                throw new Exception(
                    string.Format("Failed to create SqlConnection with connectionString: {0}", _connectionString));
            }
        }
        ...
        public void Open()
        {
            if (_conn == null)
            {
                ...
                {
                    throw new Exception("Cannot create SqlConnection with null connectionString!");
                }
        ...
        public int ExcuteSql(string sqlCmd, string[] strParams, object[] strValues)
        {
            ...
            var cmd = new SqlCommand { Connection = _conn, CommandText = sqlCmd };
